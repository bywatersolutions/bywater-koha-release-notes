...
- [[39497]](http://bugs.koha-community.org/bugzilla3/show_bug.cgi?id=39497) 'Lists' page tabs should be marked as such
...
- [[39633]](http://bugs.koha-community.org/bugzilla3/show_bug.cgi?id=39633) Inventory tool DataTable doesn't properly load
...
- [[35202]](http://bugs.koha-community.org/bugzilla3/show_bug.cgi?id=35202) Table settings should apply to multiple subscriptions in the OPAC
...
- [[39464]](http://bugs.koha-community.org/bugzilla3/show_bug.cgi?id=39464) Z39.50 Search results not highlighting grey rows in yellow when previewing
...
- [[39404]](http://bugs.koha-community.org/bugzilla3/show_bug.cgi?id=39404) Inconsistency due to "Add to list" vs "Add to a list"
...
- [[38921]](http://bugs.koha-community.org/bugzilla3/show_bug.cgi?id=38921) Remove unused href from Cancel hold link
- [[32890]](http://bugs.koha-community.org/bugzilla3/show_bug.cgi?id=32890) Add DataTables to curbside pickups
- [[38502]](http://bugs.koha-community.org/bugzilla3/show_bug.cgi?id=38502) Use Bootstrap alert info class for messages on table settings page
- [[38845]](http://bugs.koha-community.org/bugzilla3/show_bug.cgi?id=38845) OpacNoItemTypeImages required to show item type images in staff interface advanced search
...
- [[40411]](http://bugs.koha-community.org/bugzilla3/show_bug.cgi?id=40411) Koha/SearchEngine/Elasticsearch.t generates warnings
...
- [[40020]](http://bugs.koha-community.org/bugzilla3/show_bug.cgi?id=40020) Koha/AdditionalContents.t produces warnings
...
- [[39315]](http://bugs.koha-community.org/bugzilla3/show_bug.cgi?id=39315) Missing tests for KohaTable search on coded value's description
- [[39368]](http://bugs.koha-community.org/bugzilla3/show_bug.cgi?id=39368) Warnings from t::lib::Mocks::Zebra because of statement after exec
- [[39130]](http://bugs.koha-community.org/bugzilla3/show_bug.cgi?id=39130) Add unit tests for xgettext.pl
- [[39286]](http://bugs.koha-community.org/bugzilla3/show_bug.cgi?id=39286) BackgroundJob.t should mock_config
...
- [[38474]](http://bugs.koha-community.org/bugzilla3/show_bug.cgi?id=38474) t/db_dependent/Letters.t can fail randomly
- [[39007]](http://bugs.koha-community.org/bugzilla3/show_bug.cgi?id=39007) Add last_audit to the sushi_service API spec
- [[38744]](http://bugs.koha-community.org/bugzilla3/show_bug.cgi?id=38744) Tests in Koha/Biblio.t are not rolling back
...
- [[40549]](http://bugs.koha-community.org/bugzilla3/show_bug.cgi?id=40549) Warnings generated when using Import Patrons tool
- [[40400]](http://bugs.koha-community.org/bugzilla3/show_bug.cgi?id=40400) Rename club start and end date to make clearer these are for the enrollment period
- [[31930]](http://bugs.koha-community.org/bugzilla3/show_bug.cgi?id=31930) Ignore whitespace before and after barcodes when adding items to rotating collections
- [[40332]](http://bugs.koha-community.org/bugzilla3/show_bug.cgi?id=40332) Tools menu sidebar category not shown for users with batch_extend_due_dates only
- [[39289]](http://bugs.koha-community.org/bugzilla3/show_bug.cgi?id=39289) Batch extend due date tool only displays the first 20 checkouts
- [[39908]](http://bugs.koha-community.org/bugzilla3/show_bug.cgi?id=39908) Hide diff column by default in log viewer
- [[39628]](http://bugs.koha-community.org/bugzilla3/show_bug.cgi?id=39628) Display 'diff' in action logs
- [[39717]](http://bugs.koha-community.org/bugzilla3/show_bug.cgi?id=39717) Stock rotation stages cannot be moved
...
- [[37266]](http://bugs.koha-community.org/bugzilla3/show_bug.cgi?id=37266) patron_lists/delete.pl should have CSRF protection
- [[38870]](http://bugs.koha-community.org/bugzilla3/show_bug.cgi?id=38870) Remove overflow scroll from batch patron modification
...
- [[39861]](http://bugs.koha-community.org/bugzilla3/show_bug.cgi?id=39861) Z39.50/SRU servers on second page of results cannot be deleted
